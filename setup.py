...
setup(
  name = 'invoicing-pdf-m',         #* Your package will have this name
  ...
  author = 'Marxu',                   # Your name
  author_email = 'markfu1996@gmail.com',  # Your email
  url = 'https://github.com/huanhunmao/python_build_publish',              # Homepage of your library (e.g. github or your website)
